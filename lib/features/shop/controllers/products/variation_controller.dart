...
class VariationController extends GetxController {
  ...
  void onAttributeSelected (ProductModel product, attributeName, attributeValue) {
    ...
    if (selectedVariable.image.isNotEmpty){
      ImagesController.instance.selectedProductImage.value = selectedVariable.image;
    }
    selectedVariation.value = selectedVariable;
  }
  /// check if selected attribute matches any variable attribute
  bool _isSameAttributeValues(Map<String, dynamic> variableAttributes, Map<String, dynamic> selectedAttributes ){
  ...
  Set<String?> getAttributesAvailabilityInVariation(List<ProductVariationModel> variation, String attributeName) {
    final availableVariationAttributes = variation
        .where((variation) =>
    variation.attributeValue[attributeName] != null && variation.attributeValue[attributeName]!.isNotEmpty && variation.stock > 0)
