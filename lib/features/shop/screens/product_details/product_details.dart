            ...
            Padding(padding: 
              ...
              child: Column(
                 children: [
                   ...
                   /// - Attributes
                   if (products.productType == ProductType.variable.toString()) TProductAttributes(products: products,),
                   if (products.productType == ProductType.variable.toString()) const SizedBox(height: TSizes.spaceBtwSections,),
                   /// - Checkout Button
