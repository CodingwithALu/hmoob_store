    ...
    return Obx(() =>
       Column(
        children: [
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: products.productAttributeModel!.map((attribute) => Column(
              children: [
                ...
                Obx(() =>
                   Wrap(
                    ...
                    children: attribute.value!
                        .map((attributeValue) {
                          final isSelected = controller.selectedAttribute[attribute.name] == attributeValue;
                          final available = controller
                          .getAttributesAvailabilityInVariation(products.productVariations!, attribute.name!)
                          .contains(attributeValue);
                          return  TChoiceChip(text: attributeValue, selected: false, onSelected: available ? (selected){
