...
class TProductCardVertical extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final salePercentage = controller.calculatePercentage(productModel.price, productModel.salePrices);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: TSizes.spaceBtwItems / 2),
                  TBrandTitleWithVerifiedIcon(title: productModel.brand!.name,),
                ],
              ),
            ),
            const Spacer(),
            ...
            Row(
              ...
              children: [
                ...
                Flexible(
                  child: Column(
                    children: [
                      if (productModel.productType == ProductType.single.toString() && productModel.salePrices > 0)
                        Padding(
                          padding: const EdgeInsets.only(left: TSizes.sm),
                          child: TProductPriceText(price: controller.getProductPrice(productModel)),
                        ),
